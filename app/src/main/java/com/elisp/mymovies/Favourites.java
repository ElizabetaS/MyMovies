...
public class Favourites extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String sessionID = PreferencesManager.getSessionId(Favourites.this);
        if (sessionID != null && !sessionID.isEmpty()) {
            RestApi api = new RestApi(Favourites.this);
            ...
            call.enqueue(new Callback<User>() {
                ...
                public void onResponse(Call<User> call, Response<User> response) {
                    if (response.code() == 200) {
                        ...
                        Picasso.with(Favourites.this).load("http://www.gravatar.com/avatar/" + userActive.avatar.gravatar.hash)
                                .into(imgProfile);
                        PreferencesManager.addUser(userActive, Favourites.this);
                        PreferencesManager.setUserId(userActive.id, Favourites.this);
        ...
        userActive = PreferencesManager.getUser(Favourites.this);
        ...
        ButterKnife.bind(this);
        api = new RestApi(Favourites.this);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        model = PreferencesManager.getFavourite(Favourites.this);
        if(model!=null)
        {
            adapter = new FavouritesAdapter(Favourites.this,model,listener);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.explore) {
            ...
            Intent intent = new Intent(Favourites.this,Rated.class);
            startActivity(intent);

        } else if (id == R.id.watchlist) {
            Intent intent = new Intent(Favourites.this,WatchList.class);
            startActivity(intent);

        } else if (id == R.id.people) {
            Intent intent = new Intent(Favourites.this,People.class);
            startActivity(intent);

        } else if (id == R.id.logout) {
            final AlertDialog.Builder builder = new AlertDialog.Builder(Favourites.this);
            builder.setMessage("Are you sure you want to log out?")
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            SharedPreferences settings = Favourites.this.getSharedPreferences("MySharedPreffsFile", Favourites.MODE_PRIVATE);
