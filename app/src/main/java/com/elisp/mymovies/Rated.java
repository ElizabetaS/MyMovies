...
public class Rated extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String sessionID = PreferencesManager.getSessionId(Rated.this);
        if (sessionID != null && !sessionID.isEmpty()) {
            RestApi api = new RestApi(Rated.this);
            ...
            call.enqueue(new Callback<User>() {
                ...
                public void onResponse(Call<User> call, Response<User> response) {
                    if (response.code() == 200) {
                        ...
                        Picasso.with(Rated.this).load("http://www.gravatar.com/avatar/" + userActive.avatar.gravatar.hash)
                                .into(imgProfile);
                        PreferencesManager.addUser(userActive, Rated.this);
                        PreferencesManager.setUserId(userActive.id, Rated.this);
            ...
            Intent intent = new Intent(Rated.this, LogInActivity.class);
            startActivity(intent);
        }
        userActive = PreferencesManager.getUser(Rated.this);
        ...
        ButterKnife.bind(this);
        api = new RestApi(Rated.this);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        model = PreferencesManager.getRated(Rated.this);
        if(model!=null)
        {
            adapter = new RatedAdapter(Rated.this,model,listener);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.explore) {
            ...
            Intent intent = new Intent(Rated.this,Favourites.class);
            startActivity(intent);


        } else if (id == R.id.rated) {
            Intent intent = new Intent(Rated.this,Rated.class);
            startActivity(intent);

        } else if (id == R.id.watchlist) {
            Intent intent = new Intent(Rated.this,WatchList.class);
            startActivity(intent);

        } else if (id == R.id.people) {
            Intent intent = new Intent(Rated.this,People.class);
            startActivity(intent);

        } else if (id == R.id.logout) {
            final AlertDialog.Builder builder = new AlertDialog.Builder(Rated.this);
            builder.setMessage("Are you sure you want to log out?")
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            SharedPreferences settings = Rated.this.getSharedPreferences("MySharedPreffsFile", Rated.MODE_PRIVATE);
