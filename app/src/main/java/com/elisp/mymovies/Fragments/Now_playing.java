...
public class Now_playing extends android.support.v4.app.Fragment {
    ...
    {
        Call<MovieList> call = api.getNowPlaying();
        call.enqueue(new Callback<MovieList>() {
            ...
            public void onResponse(Call<MovieList> call, Response<MovieList> response) {
                if (response.code() == 200) {
                    ...
                    Toast.makeText(getContext(), "Now_playing!", Toast.LENGTH_LONG).show();
                }
            }
            @Override
